...
#define STRING_CONFIG_H_AUTHOR "Gary N McKinney" // Who made the changes.
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define XY_TRAVEL_SPEED 7500         // X and Y axis travel speed between probes, in mm/min
