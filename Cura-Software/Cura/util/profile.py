...
class setting(object):
	...
	def getLabel(self):
		if getPreference('language') is not None:
			return language.getText(self._label)
		return self._label

	def getTooltip(self):
		if getPreference('language') is not None:
			return language.getText(self._tooltip)
		return self._tooltip

	def getCategory(self):
		if getPreference('language') is not None:
			return language.getText(self._category)
		return self._category

	def getSubCategory(self):
		if getPreference('language') is not None:
			return language.getText(self._subcategory)
...
setting('language', 'chinese', str, 'preference', 'hidden').setLabel('Language')
